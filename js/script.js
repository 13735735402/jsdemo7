...
for(var i=0; i<provinceArr.length;i++){
	str += "<option value='"+i+"'>"+provinceArr[i]+"</option>"; //拼接str
}
provincesobj.innerHTML=str;
//渲染城市下拉列表，默认北京市
var str2='';
for(var i=1; i<cityArr[0].length;i++){
	str2 += "<option value='"+i+"'>"+cityArr[0][i]+"</option>"; //拼接str
}
cityobj.innerHTML=str2;
//onchange事件，省份改变时运行getCity()函数，实现省市联动
function getCity(){
    var index=provincesobj.selectedIndex;
    var value=provincesobj[index].value;;
    var citystr = '';
    for(var i=1;i<cityArr[value].length;i++){
    	citystr += "<option value='"+i+"'>"+cityArr[value][i]+"</option>"; //拼接str
    }
